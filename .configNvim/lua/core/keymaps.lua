...
keymap.set('n', '<leader>ga', '<cmd>lua vim.lsp.buf.code_action()<CR>') -- Macht Quickfixes
...
keymap.set("n","<leader>p", "<cmd>:w<CR>:!python3 %<CR>")  -- führt mit Python die aktuelle Datei aus
keymap.set("v", "J", ":m '>+1<CR>gv=gv")
keymap.set("v", "K", ":m '<-2<CR>gv=gv")

keymap.set('n', '<leader>rg', ':AsyncRun go run %<CR>')
keymap.set('n', '<leader>tg', ':AsyncRun go test<CR>')
